...
void* min_arr(void *array, size_t len, char type)
{
    type_check(type);
    ...
    if (type == 'i'){
        ...
        *min_val = *(int*)array;
        ...
        float *min_val = malloc(sizeof(float));
        memCheck(min_val);

        *min_val = *(float*)array;

        for (int i = 1; i < len; ++i){
            if( *min_val > *((float*)array + i) ){
        ...
        long *min_val = malloc(sizeof(long));
        memCheck(min_val);

        *min_val = *(long*)array;

        for (int i = 1; i < len; ++i){
            if( *min_val > *((long*)array + i) ){
                *min_val = *((long*)array + i);
            }
        }
        ...
        double *min_val = malloc(sizeof(double));
        memCheck(min_val);

        *min_val = *(double*)array;

        for (int i = 1; i < len; ++i){
            if( *min_val > *((double*)array + i) ){
